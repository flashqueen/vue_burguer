        ...
        <div>
            <form id="burguer-form" @submit="createBurguer">
                ...
                <div class="input-container" id="opcionais-container">
                    ...
                    <div class="checkbox-container" v-for="opc in opcionaisdata" :key="opc.id">
                        <input type="checkbox" name="opcionais" v-model="opcional" :value="opc.tipo">
                        <span>{{ opc.tipo }}</span>
                    </div>
                </div>
    ...
    methods: {
        ...
        async createBurguer(e) {
            ...
            const data = {
                ...
                carne: this.carne,
                pao: this.pao,
                opcionais: Array.from(this.opcional),
                status: "Solicitado"
            }
